  ...
  Widget _buildEmptyCart() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.shopping_cart_outlined, size: 100, color: kGreyMedium.withOpacity(0.5)),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      _buildQuantityButton(Icons.remove, () => _updateQuantity(item, item['quantity'] - 1)),
                      Padding(
                      ...
                      _buildQuantityButton(Icons.add, () => _updateQuantity(item, item['quantity'] + 1)),
                    ],
                  ),
                ],
              ),
